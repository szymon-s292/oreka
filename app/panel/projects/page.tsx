  ...
  return (
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-4">
        <button className="flex items-center gap-2 text-sm text-gray-500 cursor-pointer p-2 border hover:bg-gray-200 border-gray-300 rounded-md outline-none transition duration-300" onClick={() => {
...
<button onClick={loadProjectsList} className="flex items-center gap-2 text-sm px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 border border-gray-300 rounded-lg transition">
      ...
      <div className="my-4 flex gap-4 items-center h-12">
      ...
      <div className="flex flex-wrap justify-start gap-8 px-4">
