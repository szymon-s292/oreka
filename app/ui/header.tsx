...
export default function Header() {
    ...
    return (
        <header className={`lg:px-[15%] px-0 fixed bg-white w-screen z-10 ${scrolling ? "h-16" : "h-25"} transition-all duration-500 ease-in-out`} style={{ backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
            <div className="flex justify-between opacity-100 h-full">
                ...
                <nav className="flex items-center gap-5 lg:gap-10 px-2 lg:px-0">
                    ...
                    <Link href={'#projects'} className={`nav-link font-semibold ${activeSection === 'projects' ? 'text-blue-500' : ''}`}>Projekty</Link>
