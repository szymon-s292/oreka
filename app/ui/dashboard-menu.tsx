    ...
    return (
        <>
            ...
            {isMobile && !isSidebarOpen && (
                <div className="flex justify-center items-start p-2 md:hidden">
                        ...
                        <ul>
                            {navItems.map(item => (
                                <Link key={item.id} href={item.href}>
                                    <li className="w-full flex items-center px-4 py-2 cursor-pointer rounded-lg my-2 text-sm transition text-black hover:bg-gray-200 font-normal">
